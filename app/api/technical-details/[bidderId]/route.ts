...
export async function GET(request: NextRequest, { params }: { params: { bidderId: string } }) {
  try {
...
export async function PUT(request: NextRequest, { params }: { params: { bidderId: string } }) {
  try {
    const { bidderId } = params
