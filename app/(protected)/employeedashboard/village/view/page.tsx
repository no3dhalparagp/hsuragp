...
export default function ViewVillageDetails() {
  ...
  const loadOverview = useCallback(async () => {
    const res = await getVillageOverview(financialYear);
    if (res.success) {
  ...
  const loadDetails = useCallback(async () => {
    ...
    const res = await getVillageDetails(selectedId, financialYear);
    if (res.success) {
      setDetails(res.data);
    } else {
      setDetails(null);
    }
  }, [selectedId, financialYear]);
              ...
              <Tabs defaultValue="overview">
                ...
                <TabsContent value="toilet">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <Input
                      value={String(details.toilet?.totalHousehold || 0)}
                      readOnly
                    />
                    <div className="flex items-center gap-2">
                    ...
                    <Input
                      value={String(details.toilet?.toiletNotAvailable || 0)}
                      readOnly
                    />
                  </div>
                </TabsContent>
