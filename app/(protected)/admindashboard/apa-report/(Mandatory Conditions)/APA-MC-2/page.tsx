                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent className="bg-white border border-gray-200 rounded-md shadow-lg">
                          <SelectItem value="EXIST" className="hover:bg-blue-50">Exists</SelectItem>
                          <SelectItem value="NOT_EXIST" className="hover:bg-blue-50">Not Exist</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-xs" />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent className="bg-white border border-gray-200 rounded-md shadow-lg">
                          <SelectItem value="OK" className="hover:bg-blue-50">OK</SelectItem>
                          <SelectItem value="NOT_OK" className="hover:bg-blue-50">Not OK</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-xs" />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent className="bg-white border border-gray-200 rounded-md shadow-lg">
                          <SelectItem value="EXIST" className="hover:bg-blue-50">Exists</SelectItem>
                          <SelectItem value="NOT_EXIST" className="hover:bg-blue-50">Not Exist</SelectItem>
                          <SelectItem value="N/A" className="hover:bg-blue-50">Not Applicable</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-xs" />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent className="bg-white border border-gray-200 rounded-md shadow-lg">
                          ...
                          <SelectItem value="INCOMPLETE" className="hover:bg-blue-50">Incomplete</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-xs" />
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent className="bg-white border border-gray-200 rounded-md shadow-lg">
                          <SelectItem value="Satisfactory" className="hover:bg-blue-50">Satisfactory</SelectItem>
                          <SelectItem value="Not satisfactory" className="hover:bg-blue-50">Not satisfactory</SelectItem>
                        </SelectContent>
                      </Select>
                      <FormMessage className="text-xs" />
                    </FormItem>
