  ...
  useEffect(() => {
    async function fetchMeeting() {
      ...
      try {
        ...
        if (!res.ok) {
          throw new Error(
            (await res.json()).error || "Failed to fetch meeting"
          );
        }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {meeting.attendance ?? meeting.attendees?.length ?? 0} members
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="font-semibold">{meeting.financialYear}</p>
              </div>
            </div>
            <div className="flex items-center">
              <UserCheck className="mr-3 h-5 w-5 text-teal-600" />
              <div>
                <p className="text-sm text-gray-600">Quorum Achieved</p>
                <p className="font-semibold">
                  {meeting.quorumAchieved ? "Yes" : "No"}
                </p>
              </div>
            </div>
            <div className="flex items-center">
              <Building className="mr-3 h-5 w-5 text-orange-600" />
              <div>
                <p className="text-sm text-gray-600">Month</p>
                <p className="font-semibold">{meeting.month}</p>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold mb-2">Agenda Points:</h4>
            ...
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                ...
                <Badge variant="outline">
                  {meeting.attendees?.filter((a: any) => a.isPresent).length ??
                    0}{" "}
                  Present / {meeting.attendees?.length ?? 0} Total
                </Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
                        ...
                        <div className="flex items-center">
                          ...
                          <span>
                            {attendee.arrivalTime &&
                              formatDateTime(attendee.arrivalTime)}
                          </span>
                        </div>
                      )}
                    </div>
                  ...
                  <div key={resolution.id} className="border rounded-lg p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <p className="text-gray-600">{resolution.subject}</p>
                      </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <h5 className="font-semibold mb-2">Decision:</h5>
                        <p className="text-gray-700">{resolution.decision}</p>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              ₹
                              {resolution.budgetAmount?.toLocaleString?.() ??
                                resolution.budgetAmount}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              {resolution.implementationTimeline}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center">
                      ...
                      {resolution.votingResults && (
                        <div className="bg-gray-50 p-4 rounded-lg">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                            <div>
                              <span className="text-gray-600">In Favor:</span>
                              <span className="font-semibold ml-2">
                                {resolution.votingResults.inFavor}
                              </span>
                            </div>
                            <div>
                              <span className="text-gray-600">Against:</span>
                              <span className="font-semibold ml-2">
                                {resolution.votingResults.against}
                              </span>
                            </div>
                            <div>
                              <span className="text-gray-600">Abstained:</span>
                              <span className="font-semibold ml-2">
                                {resolution.votingResults.abstained}
                              </span>
                            </div>
                            <div>
                              <span className="text-gray-600">Total:</span>
                              <span className="font-semibold ml-2">
                                {resolution.votingResults.total}
                              </span>
                            </div>
                          </div>
                        </div>
            ...
            <CardContent>
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <pre className="whitespace-pre-wrap text-sm">
                      {meeting.minutes?.keyDiscussions}
                    </pre>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gray-700">
                      {formatDate(meeting.minutes?.nextMeetingDate)}
                    </p>
                    <p className="text-sm text-gray-600 mt-1">
                      {meeting.minutes?.nextMeetingAgenda}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <pre className="whitespace-pre-wrap text-sm">
                        {meeting.minutes?.attendanceSummary}
                      </pre>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h4 className="font-semibold mb-2">Special Observations:</h4>
                  <p className="text-gray-700">
                    {meeting.minutes?.specialObservations}
                  </p>
                </div>
              </div>
            </CardContent>
