                ...
                <div className="space-y-4">
                  {latestNits.length === 0 ? (
                    ...
                    latestNits.map((nit) => (
                      <div
                        key={nit.id}
                        className="group hover:bg-gray-50 rounded-lg p-4 transition-colors border"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="flex items-center space-x-2">
                              ...
                              {!nit.isPublished && (
                                <span className="inline-flex items-center px-2.5 py-0.5 text-xs font-medium text-orange-600 bg-orange-50 rounded-full">
                                  Draft
                                </span>
                              )}
                            </div>
