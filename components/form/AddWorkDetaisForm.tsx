...
export default function AddWorkDetailsForm({
  ...
  return (
    <Card className="w-full max-w-6xl mx-auto shadow-2xl rounded-2xl border-0 bg-gradient-to-br from-white to-blue-50/30">
      <CardHeader className="space-y-1 bg-gradient-to-r from-blue-700 to-indigo-700 text-white rounded-t-2xl py-8">
        <div className="flex items-center justify-center gap-3">
          <Hammer className="h-8 w-8" />
          <CardTitle className="text-3xl font-bold tracking-tight">
            Add Tender Work Details
          </CardTitle>
        </div>
        <CardDescription className="text-center text-blue-100/90 text-lg">
          Connect with approved action plans and set financial parameters
        </CardDescription>
      </CardHeader>
