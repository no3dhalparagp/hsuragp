...
import { Eye, FileText, Calendar, Building, CheckCircle, X } from "lucide-react"
...
export function TechnicalDetailsDialog({ bidderId, bidderName, onDetailsLoad }: TechnicalDetailsDialogProps) {
  ...
  const CheckItem = ({ label, value, description }: { label: string; value: boolean; description?: string }) => (
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Detailed technical evaluation and compliance check for this bidder</DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Badge
                      ...
                      className={details.qualify ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}
                    >
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">{calculateComplianceScore()}%</p>
                  </div>
                  <div>
                ...
                {details.remarks && (
                  <div>
                    ...
                    <p className="text-sm bg-muted p-3 rounded-md">{details.remarks}</p>
                  </div>
                )}
              </CardContent>
            </Card>
